...
db.define_table('franja_horaria',
                ...
                Field('dia', requires=IS_IN_SET(['1', '2', '3', '4', '5']), label='Día', unique=True),
                Field('horario', 'list:reference modulo', label='Horario', widget=SQLFORM.widgets.checkboxes.widget)
               )
